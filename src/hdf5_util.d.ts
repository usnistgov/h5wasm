...
interface Module extends EmscriptenModule {
    ...
    get_type(file_id: bigint, obj_path: string);
    ...
    get_dataset_data(file_id: bigint, path: string, arg2: null, arg3: null, arg4: bigint);
    get_dataset_metadata(file_id: bigint, path: string);
...
// type ACCESS_MODESTRING = keyof typeof ACCESS_MODE;